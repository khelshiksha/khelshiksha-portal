...
export function Schoolhouse({ gx, gy, gz }: { gx: number; gy: number; gz: number }) {
  return (
    <g>
      ...
      <Box gx={gx + 1.42} gy={gy + 0.3} gz={gz} w={0.56} d={0.56} h={1.32} material="stone" />
      <Pyramid gx={gx + 1.36} gy={gy + 0.24} gz={gz + 1.32} w={0.68} d={0.68} h={0.46} material="roof" />
      ...
      <Box gx={gx + 0.28} gy={gy + 0.9} gz={gz} w={1.34} d={1.0} h={0.78} material="stone" />
      <Pyramid gx={gx + 0.18} gy={gy + 0.8} gz={gz + 0.78} w={1.54} d={1.2} h={0.5} material="roof" />

      {/* Counting blocks in the yard — the one nod to what is taught here. */}
      <Box gx={gx + 0.32} gy={gy + 2.14} gz={gz} w={0.32} d={0.32} h={0.32} material="wood" />
      <Box gx={gx + 0.72} gy={gy + 2.18} gz={gz} w={0.28} d={0.28} h={0.28} material="wood" />
      <Box gx={gx + 0.34} gy={gy + 2.16} gz={gz + 0.32} w={0.28} d={0.28} h={0.28} material="roof" />
    </g>
  );
}

/** Climate Education — a windmill, trees and a pond. */
export function ClimateGrove({ gx, gy, gz }: { gx: number; gy: number; gz: number }) {
  const hub = iso(gx + 1.86, gy + 0.86, gz + 1.5);

  return (
    <g>
      {/* Pond, sunk very slightly so its edge reads as a bank. */}
      <Tile gx={gx + 0.18} gy={gy + 1.5} w={1.1} d={0.9} fill="var(--w-water)" gz={gz + 0.01} />
      <Tile gx={gx + 0.36} gy={gy + 1.66} w={0.5} d={0.34} fill="var(--w-water-lit)" gz={gz + 0.02} />
      ...
      <Box gx={gx + 1.78} gy={gy + 0.78} gz={gz} w={0.18} d={0.18} h={1.5} material="stone" />
      <g
        className="kv-spin"
...
export function ScienceYard({ gx, gy, gz }: { gx: number; gy: number; gz: number }) {
  const dome = iso(gx + 1.95, gy + 1.83, gz + 0.4);

  return (
    <g>
      {/* Launch pad */}
      <Box gx={gx + 0.34} gy={gy + 0.34} gz={gz} w={1.1} d={1.1} h={0.16} material="stone" />

      {/* Rocket: body, nose, and two fins. Fins are what make a cylinder read
          as a rocket rather than as a chimney. */}
      <Box gx={gx + 0.62} gy={gy + 0.62} gz={gz + 0.16} w={0.66} d={0.66} h={1.02} material="stone" />
      <Pyramid gx={gx + 0.62} gy={gy + 0.62} gz={gz + 1.18} w={0.66} d={0.66} h={0.66} material="roof" />
      <Box gx={gx + 0.44} gy={gy + 0.82} gz={gz + 0.16} w={0.2} d={0.26} h={0.44} material="coralwood" />
      <Box gx={gx + 0.82} gy={gy + 1.24} gz={gz + 0.16} w={0.26} d={0.2} h={0.44} material="coralwood" />

      <Box gx={gx + 0.6} gy={gy + 0.6} gz={gz + 0.86} w={0.7} d={0.7} h={0.2} material="coralwood" />

      {/* Exhaust — a soft plume, drifting on its own loop. */}
      <g className="kv-plume">
        <ellipse cx={iso(gx + 0.89, gy + 0.89, gz + 0.1).x} cy={iso(gx + 0.89, gy + 0.89, gz + 0.1).y} rx="15" ry="7" fill="var(--w-cloud)" opacity="0.75" />
        <ellipse cx={iso(gx + 0.89, gy + 0.89, gz + 0.1).x - 12} cy={iso(gx + 0.89, gy + 0.89, gz + 0.1).y + 4} rx="9" ry="5" fill="var(--w-cloud)" opacity="0.5" />
      </g>

      {/* Observatory: a drum with a half-dome, the classic silhouette. */}
      <Box gx={gx + 1.62} gy={gy + 1.5} gz={gz} w={0.66} d={0.66} h={0.4} material="stone" />
      <path
...
export function SportsGround({ gx, gy, gz }: { gx: number; gy: number; gz: number }) {
  ...
  return (
    <g>
      ...
      <ellipse cx={centre.x} cy={centre.y} rx="56" ry="28" fill="var(--w-coral)" opacity="0.9" />
      <ellipse cx={centre.x} cy={centre.y} rx="35" ry="17.5" fill="var(--w-grass-top)" />

      {/* Yoga deck */}
      <Box gx={gx + 1.7} gy={gy + 1.72} gz={gz} w={0.86} d={0.7} h={0.1} material="wood" />
...
export function StageYard({ gx, gy, gz }: { gx: number; gy: number; gz: number }) {
  return (
    <g>
      <Box gx={gx + 0.3} gy={gy + 0.4} gz={gz} w={1.5} d={1.2} h={0.24} material="wood" />
      ...
      <Pyramid gx={gx + 0.16} gy={gy + 0.26} gz={gz + 0.96} w={1.78} d={1.48} h={0.56} material="roof" />

      {/* Books, stacked slightly out of true. */}
      <Box gx={gx + 0.44} gy={gy + 1.92} gz={gz} w={0.62} d={0.44} h={0.12} material="stone" />
      <Box gx={gx + 0.5} gy={gy + 1.96} gz={gz + 0.12} w={0.58} d={0.4} h={0.11} material="roof" />
      <Box gx={gx + 0.46} gy={gy + 1.9} gz={gz + 0.23} w={0.56} d={0.4} h={0.11} material="wood" />
    </g>
  );
}
...
export function GroundShadow({
  ...
  return <ellipse cx={c.x} cy={c.y} rx={w * 30} ry={w * 15} fill="var(--w-grass-right)" opacity="0.35" />;
}
