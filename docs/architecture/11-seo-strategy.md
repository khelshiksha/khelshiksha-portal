...
Ranking for _"educational games India"_ is a losing fight against marketplaces. The winnable
...
export function buildMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      title,
      description,
      siteName: "Khel Shiksha",
      locale: "en_IN",
      images: [
        {
          url: image ?? ogFallback(title),
          width: 1200,
          height: 630,
          alt: title,
        },
...
- **Alt text is enforced at the CMS layer** (`accessibleImage` requires it unless marked
  decorative). Descriptive, not keyword-stuffed: _"Grade 4 students playing the Aryabhata maths
  game in a Gandhinagar classroom"_.
